...
CREATE TABLE IF NOT EXISTS PUBLIC.FILMS (
	...
	CONSTRAINT FILMS_MPA_FK FOREIGN KEY (MPA_ID) REFERENCES PUBLIC.MPA(ID) ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS PUBLIC.GENRES (
	...
	CONSTRAINT GENRES_GENRE_FK FOREIGN KEY (GENRE_ID) REFERENCES PUBLIC.GENRE(ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS PUBLIC.FRIEND (
	...
	CONSTRAINT FRIEND_UN UNIQUE (USER_ID,FRIEND_ID),
